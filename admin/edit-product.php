        ...
        if (empty($errors)) {
            ...
            $stmt = $pdo->prepare('UPDATE products 
                SET name = ?, brand = ?, category = ?, description = ?, price = ?, 
                    stock_quantity = ?, `condition` = ?, image = ?, specifications = ?, updated_at = NOW()
                WHERE id = ?');
...
<head>
    ...
    <title>Edit Product - SP Gadgets Admin</title>
        ...
        <main class="main-content">
            ...
            <div class="content-area">
                ...
                <div class="product-info-badge">
                    <i class="fas fa-box"></i>
                    <span>Product ID: <strong>#<?php echo str_pad($product['id'], 6, '0', STR_PAD_LEFT); ?></strong></span>
                    ...
                    <div class="form-card">
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="stock_quantity" min="0" value="<?php echo htmlspecialchars($product['stock_quantity']); ?>" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <span class="helper-text">Recommended size: 800x800px. Max file size: 5MB. Leave empty to keep current image.</span>
